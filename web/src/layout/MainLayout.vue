...
const MENU_BY_ROLE: Record<string, { path: string; title: string; icon: string }[]> = {
  ENTERPRISE: [
    ...
    { path: '/near-expiry', title: '临期折扣确认', icon: 'Discount' },
    { path: '/repurchase', title: '复购助手', icon: 'RefreshRight' },
    { path: '/aftersales', title: '变质售后', icon: 'FirstAidKit' },
  ...
  STORE: [
    ...
    { path: '/store-aftersales', title: '食安任务', icon: 'FirstAidKit' },
    { path: '/inventory', title: '库存与临期', icon: 'Box' },
    { path: '/near-expiry', title: '临期调拨', icon: 'Discount' },
  ...
  SERVICE: [
    { path: '/', title: '工作台', icon: 'Odometer' },
    { path: '/incidents', title: '异常工单', icon: 'Warning' },
    { path: '/near-expiry', title: '临期调拨推荐', icon: 'Discount' },
    { path: '/aftersales', title: '变质售后', icon: 'FirstAidKit' },
  ...
  FINANCE: [
    { path: '/', title: '工作台', icon: 'Odometer' },
    { path: '/finance', title: '发票与月结', icon: 'Postcard' },
    { path: '/near-expiry', title: '月结附件(临期确认)', icon: 'Discount' },
    { path: '/aftersales', title: '售后退款确认', icon: 'FirstAidKit' },
